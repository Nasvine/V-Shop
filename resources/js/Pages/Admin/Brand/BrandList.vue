...
const deleteProduct = (brand, index) => {
    console.log(index)
  Swal.fire({
    title: 'Are you Sure',
...
<template>
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <el-dialog v-model="dialogVisible" :title="editMode ? ' Edit Product' : ' Add Brand '" width="30%"
            :before-close="handleClose">
            <!-- Form Start -->
            <form class="max-w-md mx-auto" @submit.prevent="editMode ? updateBrand() : AddBrand()">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-center">Brand name</th>
                        ...
                        <tbody>
                            <tr v-for="brand in brands" :key="brand.id" class="border-b dark:border-gray-700">
                                <td class="text-center px-4 py-3">{{ brand.id }}</td>
                                <th scope="row"
                                    class="text-center px-4 py-3 ms-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ brand.name }}</th>
                                <td class="text-center px-4 py-3">{{ brand.slug }}</td>
                                <td class="text-center px-4 py-3">
                                    ...
                                    <button type="button" @click="deleteProduct(brand, brand.id)"
